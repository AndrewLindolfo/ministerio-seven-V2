...
function ensureAuthModal() {
  ...
  modal.innerHTML = `
    ...
    <div class="public-auth-modal__panel">
      ...
      <h2>Entrar</h2>
      <p>Faça login com Google para acessar recursos pessoais do site.</p>
      <button type="button" id="public-google-login-button" class="public-auth-modal__google-btn">Entrar com Google</button>
    </div>
  `;
